 ...
 * `ShowCard.Poster` (captioned when focal) and opens the show's page when its hero card is clicked.
 */
    ...
    return (
        <Md3Carousel
            ...
            renderItem={(show, { isHero }) => (
                <>
                    <ShowCard.Poster show={show} />
                    {isHero && <ShowCard.Caption show={show} />}
                </>
            )}
        />
    );
