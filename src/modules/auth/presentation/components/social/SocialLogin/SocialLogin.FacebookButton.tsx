 ...
 *
 * @description
 * Facebook sign-in button. Runs the Facebook JS-SDK login, reads the account
 * profile from the Graph API, and hands the resolved credentials to
 * `onProfile`. Must be rendered inside a `FacebookProvider`.
 *
