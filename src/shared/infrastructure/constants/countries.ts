 ...
 *
 * @description
 * A single country entry: display name, ISO 3166-1 alpha-2 code, international dial
 * code, and a flag SVG URL.
 *
 * @interface ICountryObject
 * @property {string} name - Full country name (e.g. "France").
 * @property {string} isoCode - ISO 3166-1 alpha-2 code (e.g. "FR").
 * @property {string} dialCode - International dial code (e.g. "+33").
 * @property {string} flag - Flag SVG URL.
 */
