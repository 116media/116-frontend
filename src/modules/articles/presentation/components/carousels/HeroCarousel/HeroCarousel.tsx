 ...
 * @property {IArticleSummaryEntity[]} articles - Articles shown in the hero carousel.
 */
 ...
 *
 * @description
 * Spot 1 — large hero carousel in the promotion grid, with autoplay and dot indicators.
