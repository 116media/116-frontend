 ...
 *
 * @description
 * The full-height bordered shell every favorites tile is built on: a `group` article
 * with a fixed rounded border and hover shadow so activity meta, actions, and remove
