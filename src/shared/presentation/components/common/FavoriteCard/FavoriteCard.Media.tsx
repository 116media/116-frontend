 ...
 * @property {string} [className] - Extra sizing classes merged onto the media region.
 * @property {boolean} [scaleOnHover] - Whether the thumbnail zooms when the media is hovered.
 */
...
export function FavoriteCardMedia({
    ...
    return (
        <div
            className={cn(
                "group/media relative block overflow-hidden bg-muted",
                ASPECT_CLASS[aspect],
                className
            )}
        >
