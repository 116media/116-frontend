 ...
 * followed by an optional favorites activity slot. Engagement and activity form one
 * bottom-anchored stack, with engagement always immediately before the activity details.
 */
