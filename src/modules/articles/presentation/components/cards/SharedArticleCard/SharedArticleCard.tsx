        ...
        <FavoriteCard>
            ...
            <FavoriteArticleContent article={article}>
                <FavoriteCard.Meta
                    ...
                    className="-mx-3 -mb-3 mt-auto flex justify-between gap-3 rounded-lg bg-accent/50 p-3 transition-colors group-hover:bg-muted dark:group-hover:bg-background"
                />
